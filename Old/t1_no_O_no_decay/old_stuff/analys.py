...
def main():
  ...
  run_dtw(cyclus_time, class_in[:-2], cyclus_in[:-1], "CLASS_R_Cumulative_In", "Cyclus_R_Cumulative_In","cumulRin.png")
  run_dtw(cyclus_time, class_out[:-2], cyclus_out[:-1], "CLASSS_R_Cumulative_Out", "Cyclus_R_Cumulative_Out","cumulRout.png")
